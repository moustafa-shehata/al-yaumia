...
export const TechnicalNotesCard: React.FC = () => {
  ...
  return (
    <div 
      ...
      className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-xs no-print transition-all"
    >
      <button
        onClick={() => setIsOpen(!isOpen)}
        className="w-full px-4 sm:px-6 py-3.5 flex items-center justify-between bg-slate-50/80 hover:bg-slate-100/80 transition-colors text-right cursor-pointer"
      >
